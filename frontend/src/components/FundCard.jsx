...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    ...
    <div className="sm:w-[288px]  w-full rounded-[20px]  cursor-pointer bg-white bg-opacity-25" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          <div className="flex flex-col">
            <h4 className="font-epilogue font-bold decoration-cyan-700 text-[14px] text-white leading-[22px]">{amountCollected}</h4>
            <p className="mt-[3px] font-epilogue font-bold text-[12px] leading-[18px] text-white sm:max-w-[120px] truncate">Raised of {target}</p>
          </div>
          <div className="flex flex-col">
